...
def auto_corner(frame):
    ...
    cv2.imwrite('python_images/paper_outline.jpg', output)
    cv2.imwrite('python_images/paper_edged.jpg', edged)
    cv2.imwrite('python_images/paper_final.jpg', receipt)
    cv2.imwrite('python_images/paper_gray.jpg', gray)
    return receipt
